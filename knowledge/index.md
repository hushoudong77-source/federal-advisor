...
> 最后整理：2026-08-11 11:54 | 文件数：102 | V5.8.2r33.83 在线 | 全池24标全量止损遍历回测完成，159915/510500止损修正
...
- [V5.8.2r33.32 §3.2 反击策略](analysis/v56/v56-counterpunch.md) — Counterpunch Protocol。⭐r33.32新增§3.2.1.1深穿区间+反转K线辅助确认层（锤子线/看涨吞没/十字星三形态识别，收盘距区间≤2%+盘中深穿+反转K线三条件AND→手动评估）。r24新增§3.2.4反击系统物理死亡判定≥50笔。r23双区间+SMIN剥夺+暂停降仓+48h冷却期保留。2026-07-04签发。
...
- [金盾总纲 V1.7](concepts/gold-shield-protocol-v1.md) — IAU/518880黄金专属操作协议。V1.5 S1/S2/S4废除（二级卖点S3+S6）。V1.6 C2 MA60→MA40 + MA40走平过渡态（518880 12年回测裁决，MA40 Sharpe 0.81 vs MA60 0.76）。**V1.7 C1锚点分离（518880 C1从DXY改USDCNY，汇率口径回测：累计+191.94%/Sharpe 2.980 vs 金价口径+35.63%/1.158，5.4倍）**。独立于通用法典。2026-08-21更新。
...
- [底部反转三维确认回测报告 2026-07-28](analysis/bottom-sequence-3d-backtest-2026-07-28.md) — 10标/2,988笔全量回测+L4样本外校验。三维均线方案否决（信号灭绝0.1%），二维过滤逐标启用（5标有效/5标不启用），底部确认升级为拦截器。r33.76焊入。
- [US10Y三阈值三方审计+交叉测试 2026-07-03](analysis/us10y-3threshold-final-audit-2026-07-03.md) — 三方审计四个问题裁决 + 2×2交叉测试（跳降≥10bp分区生效） + 五处法典修正焊入
...
- [五维全量宏观锚点回测报告 2026-06-28](analysis/macro-5d-full-backtest-2026-06-28.md) — 利率×美元×VIX三维全量回测(2018-2026)，五维分类后20日收益单调递减；双顺风(IR↓+DXY↓)日均+0.223%胜率59.8%最佳；CRISIS+IR↓时IVV日均+0.224%反弹最强；五维方向验证通过
- [五维评估全量回测报告 2026-07-03](analysis/5d-verdict-backtest-2026-07-03.md) — 🔴五维汇总裁决方向完全相反：RED(休战)20D+1.87% > GREEN(全仓)+0.99%。VIX维度方向颠倒——恐慌越高收益越高。利率维度预测力接近零。建议VIX方向翻转或废除五维简化为VIX+DXY二维。
- [美股进攻策略 C1 锚线松紧回测 2026-08-18](analysis/offense-c1-anchor-backtest-2026-08-18.md) — C1「现价<MA60」系统性砍掉进攻策略约1/3收益，松绑至MA20累计+252% vs 现状+228%，L4样本外16/16全通过。建议C1锚线MA60→MA20，待守东拍板。
- [全池24标全量止损遍历回测 2026-08-11](analysis/full-stoploss-backtest-2026-08-11.md) — ⭐r33.83焊入。TickFlow SDK全量日线，25标逐档1.0×~10.0×ATR遍历。核心发现：美股大盘ETF（VTI/QQQ/IVV）12年仅1-2笔止损——止损是保险非日常工具；CANE 41笔止损——分层体系正确；513770/159545止损黑洞——反击框架不成立完全证实。159915 4.0×→3.0×、510500 2.5×→5.0×。

## 📰 外部资料来源

- [沃什时代美联储顶层策略分析 2026-06](sources/warsh-era-fed-strategy-2026.md) — 守东分享深度分析：沃什"嘴鹰+缩表+利率不动"三层框架。联邦穿透审计：逻辑自洽度85%，三个致命盲区（缩表无痛论/CPI-PCE背离/阴谋论框架）。2026-06-26入库。
...
- [BOTZ 四大师对撞分析](analysis/botz-masters-collision-2026-06-27.md) — 🟡等右侧，Stage 3→4过渡，四框架一致等信号。2026-06-27入库
- [159530 四大师对撞分析](analysis/159530-masters-collision-2026-06-27.md) — 🟡等回调至¥1.456，三标中结构最健康（EMA150未破）。2026-06-27入库
- [510880 四大师对撞分析](analysis/510880-masters-collision-2026-06-27.md) — 🔴四框架一致看空，红利叙事退潮，Stage 4确认。⚠️Tushare前复权¥1.602 vs 腾讯真实价¥2.954（复权因子1.844×，非除权），买入区间修正为¥2.964。2026-06-27入库
...
- [MACD指标完整拆解 — 底层逻辑×联邦实战](concepts/macd-full-deconstruction.md) — 三组件计算原理/金叉三级质量/六大嵌入位置/回测数据/BAR柱深度用法/三大经典陷阱/使用优先级。核心结论：纯金叉胜率≈52%，联邦体系内仅在动量跟随策略中扮演主角。2026-07-08入库。
- [A股进攻策略完整框架](concepts/a-stock-offensive-strategy.md) — 替代原C1-C4框架。双轨互斥（MA5回踩+MA60回踩），仅牛市执行。四标MA5回踩+两标MA60回踩，逐标独立止盈（固定%/MA20/分批）。吊灯止盈系统性跑输分批固定%。2026-07-08入库。

## 📋 自审与审计日志

- [V5.8.2 自审修复日志 L1-L88](analysis/self-audit-log-v582.md) — ⚠️已从AGENT.md剥离（2026-08-12）。68KB，88条修复记录。仅在 `/自审` 或追溯历史修正时加载。
